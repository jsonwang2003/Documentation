...
- Write a function that takes a [[Computer Systems/System Programming/Strings and Data/UTF-8]] encoded null-terminated `char[]` string and an integer `index` (**codepoint index**)
