...
- Take a [[Computer Systems/System Programming/Strings and Data/UTF-8]] encoded string and change it *in-place* so that any [[ASCII]] uppercase characters `a-z` are changed to their lowercase version
