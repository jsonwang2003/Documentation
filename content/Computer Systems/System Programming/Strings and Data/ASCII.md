...
> - **7-bit** character code where **each individual bit represents a unique character**
...
- Common for all the different variations of the ASCII table
- includes
...
| Dec | Oct | Hex | Bin      | Char | HTML     | Entity   | Description                            |
| --- | --- | --- | -------- | ---- | -------- | -------- | -------------------------------------- |
...
- **8-bit** ASCII table
- according to **Windows-1252 (CP-1252)** &rarr; a subset of of **ISO 8859-1 (ISO Latin-1)** in terms of printable characters
- differs from **IANA's ISO-8859-1** by using displayable characters rather than **control characters** in the 128-159 range
...
| 155 | 233 | 9B  | 10011011 | ›    | `&#155;`  | &rsaquo; | Single right-pointing angle quotation  |
...
| 166 | 246 | A6  | 10100110 | ¦    | `&#166;`  | &brvbar; | Broken vertical bar                    |
| 167 | 247 | A7  | 10100111 | §    | `&#167;`  | &sect;   | Section sign                           |
| 168 | 250 | A8  | 10101000 | ¨    | `&#168;`  | &uml;    | Spacing diaeresis                      |
...
| 174 | 256 | AE  | 10101110 | ®    | `&#174;`  | &reg;    | Registered trademark                   |
...
| 223 | 337 | DF  | 11011111 | ß    | `&#223;`  | &szlig;  | Latin small letter sharp s             |
