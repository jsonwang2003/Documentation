...
description: "Index for Intro to Systems Programming, covering C pointers, references, returning pointers, sizeof evaluations, and SHA256 hashing." 
aliases: 
- Intro to Systems Programming Hub 
- C Fundamentals 
tags: 
- index 
- system-programming 
