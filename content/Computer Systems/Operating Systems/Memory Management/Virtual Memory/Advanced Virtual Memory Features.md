...
> - **Core Driver:** Manipulating [[Page Table Entries & Memory Overhead|Page Table Entries]] and protection bits to trigger lazy evaluation.
...
*   **Lazy Demand Paging:** Pages of the file are loaded into RAM lazily via [[Demand Paging & Page Faults|Demand Paging]] as they are referenced.
...
- [[Process Lifecycle & API|Process Lifecycle & API]]