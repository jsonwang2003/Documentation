...
> [!IMPORTANT]
> To find the maximum value in the candies array, we can use the C++ STL algorithm: `max_element` found [here &rarr;](https://cplusplus.com/reference/algorithm/max_element/)
2. For each kid, add the extra candies to see if they are greater than or equal to the maximum value and store the Boolean into the `result`
