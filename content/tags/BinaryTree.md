...
> [!INFO]
> A hierarchical data structure in which each node has **at most two children**, referred to as the left and right child. Unlike [[BinarySearchTree|BinarySearchTree]], Binary Trees do not **enforce any ordering constraints between node values**.
