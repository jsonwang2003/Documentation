...
- **[[Syntax/index|C Syntax]]**: Deepens understanding of arrays (`char *`) and loop structures for stream processing.
- **[[Discrete Structures/Counting/index|Counting]]**: Relevant for understanding the collision resistance and output space ($2^{256}$) of SHA256.
- **[[Computer Science/Programming Languages/C/Practice Examples/Lecture Examples/Intro to Systems Programming/index|Lecture: Memory and System Calls]]**: Background on how the OS passes arguments and handles file descriptors.