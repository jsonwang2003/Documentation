...
- **[[Syntax/index|Syntax and Basics]]**: The entry point for C. Covers data types, arrays, control flow, and standard I/O.
- **[[Practice Examples/Lecture Examples/index|Lecture Examples]]**: Conceptual deep dives into how the Operating System manages processes, pointers, and memory headers.

---
## Curriculum Map
### [[Practice Examples/Lecture Examples/Memory Management/index|Memory Management]]
...
### [[Practice Examples/Lecture Examples/Strings and Data/index|Strings and Data]]
...
### [[Practice Examples/Lecture Examples/Digital Communication/index|Digital Communication]]
...
## [[Practice Examples/Problem Sets 1/index|Problem Set 1: Bits and Encodings]]
...
## [[Practice Examples/Problem Sets 2/index|Problem Set 2: Standard I/O and Hashing]]
...
## [[Practice Examples/Problem Sets 3/index|Problem Set 3: Processes and Shells]]
...
## [[Practice Examples/Problem Sets 4/index|Problem Set 4: The Heap Allocator]]
...
## [[Practice Examples/Problem Sets 5/index|Problem Set 5: Web Servers]]
...
- **[[Practice Examples/Program Assessments/UTF-8|UTF-8]]**: A robust encoder and decoder for Unicode characters.
- **[[Practice Examples/Program Assessments/Hashing and Passwords|Hashing and Passwords]]**: Implementing secure data verification and password storage logic using SHA256.
- **[[Practice Examples/Program Assessments/The Pioneer Shell|The Pioneer Shell]]**: A custom-built Unix shell featuring process control and command parsing.
- **[[Practice Examples/Program Assessments/Malloc|Malloc]]**: A custom heap memory manager implementing dynamic allocation and freeing logic.
- **[[Practice Examples/Program Assessments/Web Server|Web Server]]**: A multi-functional HTTP server capable of handling network requests and serving content.