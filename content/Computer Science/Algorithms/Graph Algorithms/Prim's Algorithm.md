...
> [!abstract] 
> **What it is:** Prim's Algorithm is a [[Computer Science/Algorithms/Greedy Algorithms/index|Greedy Algorithm]] that builds a **[[Minimum Spanning Trees|Minimum Spanning Tree (MST)]]** for a connected, undirected, weighted graph by repeatedly growing a single tree one cheapest edge at a time.
> 
