...
---
> [!abstract] Abstract 
> A Circular Array is a regular [[Introductory Data Structures/Array Lists|Array List]] with an implementation that mimics the boundary properties of a [[Introductory Data Structures/Linked List|Linked List]]. It treats the underlying linear array as a continuous ring by tracking `head` and `tail` indices.
> 
...
When the backing array becomes fully saturated, it must be resized. Similar to a standard [[Introductory Data Structures/Array Lists|Array List]], the engine doubles array capacity and copies existing entries.
...
Unlike a [[Introductory Data Structures/Linked List|Linked List]], a Circular Array retains $O(1)$ Random Access capabilities. To access logical element $i$, calculate its physical index via modular arithmetic:
...
**Conclusion:** Circular Arrays provide the efficient boundary manipulation of a [[Introductory Data Structures/Linked List|Linked List]] while retaining the constant-time random access of an [[Introductory Data Structures/Array Lists|Array List]]. This makes them ideal for backing [[Introductory Data Structures/Deques|Deques]] and [[Introductory Data Structures/Queues|Queues]].
