...
---
> [!abstract] Abstract 
> A Heap is a specialized tree-based data structure that satisfies strict structural shape invariants and relative priority ordering properties. Bypassing the pointer overhead of traditional dynamic trees, it serves as the standard physical implementation layer for the [[Introductory Data Structures/Priority Queue|Priority Queue ADT]].
> 
