...
---
## 1. Algebraic Proof
Using the **[[Identities/Binomial Theorem|Binomial Theorem]]**, we can expand $(x+y)^n$:
...
- **RHS ($2^n$)**: For a binary string of length $n$, each of the $n$ positions has 2 choices (`0` or `1`). By the **[[Counting Techniques/Product Rule|Product Rule]]**, there are $2 \times 2 \times \dots \times 2 = 2^n$ total strings.
...
> [!INFO]
> By the [[Counting Techniques/Sum Rule|Sum Rule]], the total number of strings is the sum of these disjoint cases from $k=0$ to $n$.
...
- Therefore, the size of the **[[Counting Techniques/Power Rule|Power Set]]** is always $2^n$.
