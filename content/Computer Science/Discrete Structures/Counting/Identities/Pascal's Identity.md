...
As you noted, we can think of this as counting binary strings of length $n+1$ with exactly $k$ ones. By the **[[Counting Techniques/Sum Rule|Sum Rule]]**, we can partition all such strings into two mutually exclusive sets based on the value of the **last bit**.
### LHS: Total Count
