...
- This is why binomial coefficients are also the entries in **[[Identities/Pascal's Identity|Pascal's Triangle]]**.
...
- **Counting Meaning**: The total number of subsets of a set of size $n$ (the **[[Counting Techniques/Power Rule|Power Set]]**) is $2^n$.
### Alternating Sum
Let $x = 1$ and $y = -1$:
...
While the Binomial Theorem describes how to expand a union-like algebraic structure, it is often used to simplify the terms found in the **[[Counting Techniques/Inclusion Exclusion|Principle of Inclusion-Exclusion (PIE)]]**.
