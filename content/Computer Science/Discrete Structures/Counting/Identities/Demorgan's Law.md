...
> [!IMPORTANT]
> This allows us to use the **[[Counting Techniques/Inclusion Exclusion|Inclusion-Exclusion Principle]]** to calculate $|A_1 \cup A_2 \cup \dots \cup A_n|$ and subtract it from the total.
