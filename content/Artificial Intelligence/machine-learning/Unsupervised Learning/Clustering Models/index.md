...
- ### [[Divisive Clustering]]
> Top-down hierarchical method that begins with all data in one cluster and recursively splits it into smaller, more homogeneous groups. Useful for semantic taxonomies and scalable documentation structures, especially when global data structure matters.
...
- [[Artificial Intelligence/machine-learning/Unsupervised Learning/index|Unsupervised Learning]] — Broader context for pattern discovery without labels  
- [[Data Science/Model Evaluation/index|Model Evaluation]] — Metrics like silhouette score, Davies-Bouldin index, and inertia  
- [[Artificial Intelligence/machine-learning/Unsupervised Learning/Dimensionality Reduction Models/index|Dimensionality Reduction Models]] — Often used before clustering to simplify high-dimensional data