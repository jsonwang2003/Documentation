...
1. [[Frequent Pattern Tree (FP-Tree)]] Construction  
...
- More efficient than Apriori
    ...
    - Reduces computational overhead using [[Frequent Pattern Tree (FP-Tree)]]
...
- Can be memory-intensive
    - [[Frequent Pattern Tree (FP-Tree)]] construction and traversal require additional data structures
- Less interpretable compared to [[Apriori Algorithm]]
