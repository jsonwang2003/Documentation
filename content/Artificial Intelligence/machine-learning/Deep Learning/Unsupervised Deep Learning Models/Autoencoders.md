...
- uses [[Artificial Intelligence/machine-learning/Unsupervised Learning/index|Unsupervised Learning]], minimizing a **reconstruction loss** between the input and output
## Goal
- [[Artificial Intelligence/machine-learning/Unsupervised Learning/Dimensionality Reduction Models/index|Dimensionality Reduction]]: distill complex, high-dimensional data into a reduced, meaningful representation or latent space
