...
- [[Artificial Intelligence/machine-learning/Unsupervised Learning/index|Unsupervised Learning]] — Broader context including classical models  
- [[Hybrid Deep Learning Models]] — For architectures combining unsupervised and supervised components  
- [[Data Science/Model Evaluation/index|Model Evaluation]] — For metrics like reconstruction error, clustering purity, or likelihood