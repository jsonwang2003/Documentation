...
1.  **Hash Set:** Backed by a [[Hash Tables|Hash Table]]. Delivers $O(1)$ average-case operations; order is arbitrary.
2.  **Tree Set:** Backed by a self-balancing search tree (e.g., [[Red-Black Tree|Red-Black Tree]]). Maintains elements in sorted order with $O(\log n)$ bounds.
...
- [[Computer Science Introduction/Data Structures/Pair|Pair]]
