...
1. Assemble a standard [[Multiway Trie|Multiway Trie]] containing all targeted search patterns.
...
| **[[Multiway Trie \|Multiway Trie Structure]]** | $O(n \cdot k)$          | Moderate (Requires pattern rollbacks) |
| **[[Aho-Corasick Automaton]]**                  | $O(n)$                  | Optimal Linear Throughput             |
