...
### What is a Graph?
A graph is a non-linear mathematical structure used to model arbitrary relationships between discrete objects. Unlike [[Computer Science Introduction/Data Structures/Tree Structures/index|Tree Structures]], graphs have no built-in global root node or strict parent-child hierarchies. Instead, they form custom topographical networks that can be:
...
## Related Categories
*   [[Computer Science Introduction/Data Structures/Tree Structures/index|Tree Structures Overview]]
*   [[Computer Science Introduction/Data Structures/Coding and Information Compression/index|Coding and Information Compression foundations]]