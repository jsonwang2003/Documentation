...
---
> [!abstract] Abstract 
> A Deque (Double-Ended Queue) is an [[Abstract Data Types (ADT)|Abstract Data Type]] that allows for insertion and removal of elements from both the front and the back. It serves as a generalized linear list supporting bi-directional growth, combining [[Computer Science Introduction/Data Structures/Introductory Data Structures/Stack|Stack]] and [[Queues|Queue]] workflows into a single interface.
> 
