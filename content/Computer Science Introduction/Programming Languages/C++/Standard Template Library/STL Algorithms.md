...
### Improve Readability
- **No Abbreviation** for identifiers for [[Computer Science Introduction/Programming Languages/C++/Standard Template Library/index#Containers|STL Containers]]
- If using for **Multiple** types of [[Computer Science Introduction/Programming Languages/C++/Standard Template Library/index#Containers|STL Containers]] → choose identifiers **clearly denote** the type of iterator
