...
#### Make Pair function
- Use the [[Computer Science Introduction/Programming Languages/C++/Standard Template Library/Pair|STL Pair]] member function `make_pair`
```cpp
map<int, double> map5;
for(int i = 0; i < 6; ++i){
...
---
## Member Functions
- `map::insert()`: Insert a [[Computer Science Introduction/Programming Languages/C++/Standard Template Library/Pair|Pair]] into the map
	- `map::insert(pair<T, T>{key, value})`
		- Declare and initialize the pair in the argument
	- `map::insert(make_pair(key, value))`
		- Utilize the `make_pair` function from the [[Computer Science Introduction/Programming Languages/C++/Standard Template Library/Pair|Pair]] class
