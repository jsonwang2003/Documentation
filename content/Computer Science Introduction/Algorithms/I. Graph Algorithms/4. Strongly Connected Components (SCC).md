...
- **DFS / `explore`** — see [[3. Depth First Search (DFS)|Depth First Search (DFS)]] and [[1. Explore|Explore]] for the underlying traversal and `post` timestamp mechanics used here
...
> [!Info] 
> The vertex with the **greatest** post number in any [[1. Explore#DFS Output Tree Keep Track of Paths|DFS Output Tree]] belongs to a **source** SCC.
