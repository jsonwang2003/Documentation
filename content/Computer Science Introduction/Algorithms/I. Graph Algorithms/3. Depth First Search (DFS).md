...
> [!ABSTRACT] 
> **Depth-First Search (DFS)** is a graph traversal algorithm that explores as far as possible along each branch before backtracking. While [[6. Breadth First Search (BFS)|BFS]] explores "wide," DFS explores "deep," making it highly memory-efficient for specific graph structures.
> 
...
`explore` is the recursive heart of DFS. It visits a single vertex and recursively follows all unvisited neighbors. For more information, visit [[1. Explore|Explore]]
