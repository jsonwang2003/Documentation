...
> 
> - **Category:** Network Flow / Combinatorial Optimization (also formulable as [[Computer Science Introduction/Algorithms/Linear Programming/index|Linear Programming]])
...
Since every constraint above (capacity, conservation) and the objective (total flow) are linear, Max Flow is technically solvable directly as an instance of [[Computer Science Introduction/Algorithms/Linear Programming/index|Linear Programming]]. But the problem's graph structure supports a more specialized, more efficient combinatorial algorithm instead.
