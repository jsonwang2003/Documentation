...
Two of the three general techniques (see [[3. Techniques to Prove Optimality|Proving Greedy Optimality]] for the complete overview of all three) apply cleanly here, giving two independent proofs of the same result.
...
- [[1. The Greedy Method|The Greedy Method]]
- [[3. Techniques to Prove Optimality|Proving Greedy Optimality]]
- [[5. Prove Kruskal's with Exchange Argument|Kruskal's Exchange Argument Proof]]
