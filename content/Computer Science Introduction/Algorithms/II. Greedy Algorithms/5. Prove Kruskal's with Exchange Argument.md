...
---
> [!abstract] Abstract 
> [[8. Kruskal's Algorithm|Kruskal's Algorithm]] is already shown correct in its own note via the [[10. Cut Property|Cut Property]]. This note gives an **independent, second proof** of the same result, using the [[3. Techniques to Prove Optimality#Exchange Argument (Modify-the-Solution)|Exchange Argument]] technique instead — a worked example of applying that general technique to a specific algorithm.
...
- [[8. Kruskal's Algorithm|Kruskal's Algorithm]] — the algorithm itself, plus the alternative Cut Property proof
- [[10. Cut Property|Cut Property]] — the technique used in Kruskal's own note
- [[3. Techniques to Prove Optimality|Techniques to Prove Optimality]] — general write-up of the Exchange Argument and its alternatives