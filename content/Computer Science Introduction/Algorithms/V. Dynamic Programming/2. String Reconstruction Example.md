...
title: String Reconstruction Example
---
> [!abstract] 
...
- **Objective / Goal:** Like [[Computer Science Introduction/Algorithms/III. Divide and Conquer/4. Selection/index|Selection]], this is a decision/existence problem rather than an optimization over many valid solutions — there's no "better" split to maximize, just "does at least one valid split exist."
...
- **No notion of "best" split.** If disambiguating between multiple valid splits matters (e.g. preferring fewer, longer words, or the most common words), this needs to become an optimization variant — assign each word a value/cost and maximize/minimize over valid splits, the same way [[1. Weighted Event Scheduling Example|Weighted Event Scheduling]] extends plain [[2. Event Scheduling Example|Event Scheduling Example]].
...
- [[1. Weighted Event Scheduling Example|Weighted Event Scheduling]]
