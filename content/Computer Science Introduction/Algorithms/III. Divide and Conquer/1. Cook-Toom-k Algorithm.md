...
> - **Output:** The product
> - **Paradigm:** Divide and Conquer, generalizing [[Computer Science Introduction/Algorithms/III. Divide and Conquer/index#Multiplying n-bit Numbers (Classic Recursive Approach)|Karatsuba's]] 2-way split to a $k$-way split
...
| ----------------- | ------------------------------------ | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| $k=2$ (Karatsuba) | $\log_2 3 \approx 1.585$             | Small, constant                       | The classic special case — see [[Computer Science Introduction/Algorithms/III. Divide and Conquer/index#Multiplying n-bit Numbers (Classic Recursive Approach)\|Multiply Problem]] |
...
- [[Computer Science Introduction/Algorithms/III. Divide and Conquer/index#Multiplying n-bit Numbers (Classic Recursive Approach)|Multiply Problem]]
- [[Master Theorem]]
