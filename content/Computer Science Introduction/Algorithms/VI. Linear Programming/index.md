...
> [!abstract] Overview 
> Linear Programming is a general method of solving optimization problems, applicable whenever the constraints and objective function are all linear equations or inequalities. Many problems that look combinatorial — like [[1. Maximum Flow Example\|Maximum Flow]] — can be formulated and solved this way, though specialized combinatorial algorithms often outperform a generic LP solver for problems with enough extra structure.
...
| Note                                      | Description                                                                                                                                                                                             |
| :---------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [[1. Maximum Flow Example\|Maximum Flow]] | Network flow — technically an LP problem (linear constraints and objective), but solved via the specialized, more efficient Ford-Fulkerson augmenting-path method instead of generic Simplex. |
