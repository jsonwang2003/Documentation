...
- [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Algorithm Analysis/index|Algorithm Analysis]] – Understanding why $O(n \log n)$ is better than $O(n^2)$.
- [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Recursive Algorithms/Divide and Conquer/index|Divide and Conquer]] – The algorithm design pattern that creates these recurrences.