...
---
## Why Sort?
- **Efficiency**: Sorted data enables faster operations (e.g., [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Searching/Binary Search]] or finding Min/Max).
...
- **Algorithmic Variety**: Sorting is the perfect playground for learning:
    ...
    - **Recursive / Divide & Conquer** ([[Computer Science Theory/Discrete Structures/Discrete Algorithms/Recursive Algorithms/Divide and Conquer/Merge Sort]])
...
---
## Related Toolkits
- [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Recursive Algorithms/Divide and Conquer/Merge Sort|Merge Sort]] – Scaling sorting to $O(n \log n)$.
