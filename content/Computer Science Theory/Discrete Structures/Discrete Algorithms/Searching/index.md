...
### [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Searching/Binary Search]]
...
- [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Recursive Algorithms/Divide and Conquer/Merge Sort|Merge Sort]]: Why we often sort data first (to enable $O(\log n)$ searching later).