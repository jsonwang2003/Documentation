...
> [!INFO]
> 
> Mathematically, we say [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Searching/Binary Search]] is **asymptotically faster** than [[Linear Search]]. Even if *Linear Search* was running on a supercomputer and *Binary Search* on a calculator, for a large enough $n$, **Binary Search will always win**.
...
- [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Recursive Algorithms/Divide and Conquer/Merge Sort]] – Often used as a prerequisite to enable Binary Search.
