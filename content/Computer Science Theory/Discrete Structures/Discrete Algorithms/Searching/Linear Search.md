...
| Simple to implement and requires no extra memory. | Inefficient compared to [[Computer Science Theory/Discrete Structures/Discrete Algorithms/Searching/Binary Search]] for sorted data.            |
