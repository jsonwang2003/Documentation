...
---
## Related Toolkits
- **[[Computer Science Theory/Discrete Structures/Probability/Laws of Probability/index|Laws of Probability]]**: Provides the underlying logic for independence and conditional probability used in these distributions.
- **[[Computer Science Theory/Discrete Structures/Probability/Expected Values and Analysis/index|Expected Value and Analysis]]**: Advanced techniques like **Linearity of Expectation** and **Case Analysis** used to solve complex problems involving these variables.