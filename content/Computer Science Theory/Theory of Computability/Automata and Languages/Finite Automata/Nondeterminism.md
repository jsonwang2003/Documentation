...
> [!Note] 
> Unlike [[Computer Science Theory/Theory of Computability/Automata and Languages/Finite Automata/index#How it Computes (Deterministic Computation)|Deterministic Computation]] where the next state is determined to be a specific state, **Nondeterministic Machine** has *several* choices that exists for the next state at any point.
> 
